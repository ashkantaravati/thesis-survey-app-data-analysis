...
rep.h3
plot(teams$coordination ~ teams$overconfidence, data = teams,xlab="Team Coordination", ylab="Team Overconfidence")
abline(lm(coordination ~ overconfidence,data=teams), col="blue")
