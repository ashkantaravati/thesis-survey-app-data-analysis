...
Coordination and Voice Behavior are the most correlated variables with the Effectiveness, so they are kept.
...
The elimination of either History or Tenure seems to reduce the goodness of fit of the model. Therefore both are kept.
